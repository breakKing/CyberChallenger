...
namespace TeamService.Persistence.Migrations
{
    ...
    [Migration("20230311204142_AddEntitiesForEventSourcing")]
    partial class AddEntitiesForEventSourcing
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Shared.Infrastructure.EventSourcing.Persistence.Entities.MessageStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 3, 11, 20, 41, 42, 90, DateTimeKind.Unspecified).AddTicks(8979), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Не задан",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 3, 11, 20, 41, 42, 90, DateTimeKind.Unspecified).AddTicks(8979), new TimeSpan(0, 0, 0, 0, 0)),
                            Version = 0u
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 3, 11, 20, 41, 42, 90, DateTimeKind.Unspecified).AddTicks(9749), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Подготовлено к отправке в топик",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 3, 11, 20, 41, 42, 90, DateTimeKind.Unspecified).AddTicks(9749), new TimeSpan(0, 0, 0, 0, 0)),
                            Version = 0u
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 3, 11, 20, 41, 42, 90, DateTimeKind.Unspecified).AddTicks(9751), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Успешно отправлено в топик",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 3, 11, 20, 41, 42, 90, DateTimeKind.Unspecified).AddTicks(9751), new TimeSpan(0, 0, 0, 0, 0)),
                            Version = 0u
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 3, 11, 20, 41, 42, 90, DateTimeKind.Unspecified).AddTicks(9752), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Успешно обработано",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 3, 11, 20, 41, 42, 90, DateTimeKind.Unspecified).AddTicks(9752), new TimeSpan(0, 0, 0, 0, 0)),
                            Version = 0u
                        });
                });
