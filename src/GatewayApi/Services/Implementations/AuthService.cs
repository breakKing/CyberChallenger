...
public sealed class AuthService : IAuthService
{
    ...
    public AuthService(IHttpClientFactory httpClientFactory, IOptions<AuthOptions> authOptions, 
        IRefreshTokenService refreshTokenService, ILogger<AuthService> logger)
    {
