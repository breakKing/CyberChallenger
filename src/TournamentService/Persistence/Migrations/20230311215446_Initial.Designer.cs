...
namespace TournamentService.Persistence.Migrations
{
    ...
    [Migration("20230311215446_Initial")]
            ...
            modelBuilder.Entity("Shared.Infrastructure.EventSourcing.Persistence.Entities.MessageStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 3, 11, 21, 54, 46, 47, DateTimeKind.Unspecified).AddTicks(1163), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Не задан",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 3, 11, 21, 54, 46, 47, DateTimeKind.Unspecified).AddTicks(1163), new TimeSpan(0, 0, 0, 0, 0)),
                            Version = 0u
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 3, 11, 21, 54, 46, 47, DateTimeKind.Unspecified).AddTicks(2011), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Подготовлено к отправке в топик",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 3, 11, 21, 54, 46, 47, DateTimeKind.Unspecified).AddTicks(2011), new TimeSpan(0, 0, 0, 0, 0)),
                            Version = 0u
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 3, 11, 21, 54, 46, 47, DateTimeKind.Unspecified).AddTicks(2013), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Успешно отправлено в топик",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 3, 11, 21, 54, 46, 47, DateTimeKind.Unspecified).AddTicks(2013), new TimeSpan(0, 0, 0, 0, 0)),
                            Version = 0u
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTimeOffset(new DateTime(2023, 3, 11, 21, 54, 46, 47, DateTimeKind.Unspecified).AddTicks(2014), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            Name = "Успешно обработано",
                            UpdatedAt = new DateTimeOffset(new DateTime(2023, 3, 11, 21, 54, 46, 47, DateTimeKind.Unspecified).AddTicks(2014), new TimeSpan(0, 0, 0, 0, 0)),
                            Version = 0u
                        });
                });
